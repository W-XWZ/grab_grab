...
//保存输入的条件
	...
	// function displayConditionList(editPriorNum){
	// 	let innerHTML = `
	// 				优先度` + editPriorNum + `:
...
export  {matchConditionByVariety,loadupDisplayCondition, conditionPanelInnerHtml,getParam, makeConditionStore,addConditionPanelHtml, displayWarehouseTable,displayWareHouseValue, editConditionByVariety,validateCondition}